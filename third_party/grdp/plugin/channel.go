...
//static channel name
const (
	CLIPRDR_SVC_CHANNEL_NAME = "cliprdr" //е‰Єе€‡жќї
	RDPDR_SVC_CHANNEL_NAME   = "rdpdr"   //и®ѕе¤‡й‡Ќе®љеђ‘(ж‰“еЌ°жњєпјЊзЈЃз›пјЊз«ЇеЏЈпјЊж™єиѓЅеЌЎз­‰)
	RDPSND_SVC_CHANNEL_NAME  = "rdpsnd"  //йџійў‘иѕ“е‡є
	RAIL_SVC_CHANNEL_NAME    = "rail"    //иїњзЁ‹еє”з”Ё
	ENCOMSP_SVC_CHANNEL_NAME = "encomsp" //е¤љж–№и™љж‹џйЂљйЃ“
	REMDESK_SVC_CHANNEL_NAME = "remdesk" //иїњзЁ‹еЌЏеЉ©
)
